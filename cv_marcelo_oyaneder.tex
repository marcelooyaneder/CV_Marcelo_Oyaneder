...
%  \mailaddress{Address, Street, 00000 County}
  \location{Humberto Diaz Casanueva 11057, La Pintana, Santiago}
...
\cvevent{Ingeniero de proyectos de ingeniería}{Partículas Ingeniería y Gestión Ambiental}{2021}{Santiago, Chile}
\begin{itemize}
	\item Creación de modelos y simulación de estos en software de mecánica de fluidos computacional.
  \item Análisis estadístisco en calidad del aire. 
\end{itemize}
...
\cvevent{Ayudante}{Departamento de Ingeniería Química}{2019-2021}{Universidad de Santiago de Chile}
\begin{itemize}
...
\begin{itemize}
\item 7$^\circ$ básico a 4$^\circ$ - Instituto Nacional Gral. Jose Miguel Carrera
\end{itemize}


\medskip

\cvsection[page2sidebar]{Presentaciones}
